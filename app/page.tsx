      ...
      <main className="min-h-screen bg-white overflow-x-hidden">
        ...
        <header className="sticky top-0 z-50 bg-gray-950/85 backdrop-blur-xl border-b border-white/5 shadow-lg shadow-black/20">
          <div className="max-w-6xl mx-auto px-4 py-3 flex items-center justify-between">
            ...
            <MagBtn href={kit.link} onClick={triggerLoad}              className="btn-mag bg-gradient-to-r from-purple-600 to-violet-600 text-white px-5 py-2.5 rounded-full text-sm font-bold shadow-lg shadow-purple-900/40">
              Comprar Agora →
            </MagBtn>
          </div>
        </header>
          ...
          <div className="max-w-6xl mx-auto px-4 pt-4 pb-10 lg:pt-10 lg:pb-16 grid lg:grid-cols-2 gap-4 lg:gap-12 items-center relative z-10">
            ...
            <div className="order-2 lg:order-1">
              ...
              <div className="fade-up-4 flex flex-col sm:flex-row gap-3 mb-5">
                <MagBtn href={LINK_1} onClick={triggerLoad}                  className="btn-mag flex-1 text-center bg-gradient-to-r from-purple-600 to-violet-600 text-white px-8 py-4 rounded-2xl text-base font-black shadow-xl shadow-purple-900/50">
            ...
            <div className="relative rounded-3xl overflow-hidden reveal buybox-shine"
              ...
              <div className="relative px-8 py-10 lg:px-14 lg:py-12">
                ...
                <div className="flex justify-center mb-8">
                  <MagBtn href={kit.link} onClick={triggerLoad}                    className="btn-white-hover inline-block bg-white text-purple-700 px-12 py-5 rounded-2xl text-xl font-black shadow-2xl tracking-tight">
        ...
        <section className="relative py-28 px-4 overflow-hidden hero-noise" style={{ background: '#08080f' }}>
          ...
          <div className="max-w-3xl mx-auto text-center relative z-10">
            ...
            <div className="reveal flex flex-col gap-3 items-center mb-8">
              <MagBtn href={kit.link} onClick={triggerLoad}                className="btn-mag bg-gradient-to-r from-purple-600 to-violet-600 text-white px-14 py-5 rounded-2xl text-xl font-black shadow-2xl shadow-purple-900/60 w-full sm:w-auto text-center">
